...
<%
  ...
  try{
      ...
      st=conn.createStatement();
       String quer="select name,email,mobile,city,nam,eid,studentid,courseid from studentMaster Inner join CoursesEnrolled on CoursesEnrolled.studentid=studentMaster.id Inner join CourseMaster on CoursesEnrolled.courseid=CourseMaster.id;";
...
CoursesEnrolled(studentid,courseid),feepaid
 ...
 %>
            <tr>
                <td><%=rs.getInt("eid")%></td>
                <td><%=rs.getString("name")+"::"+rs.getString("email")+"::"+rs.getString("mobile")+"::"+rs.getString("city")%></td>
