...
<%
  ...
  try{
     ...
     String city=request.getParameter("city");
       String qq="Update studentInput set id="+id+" where id="+id+" ;";
        int resu = st.executeUpdate(qq);
        String r="Update studentInput set name='"+name+"' where id="+id+" ;";
        int rer = st.executeUpdate(r);
        String up="Update studentInput set passord='"+passord+"' where id="+id+" ;";
         int rr = st.executeUpdate(up);
        String uup="Update studentInput set email='"+email+"' where id="+id+" ;";
        int ry = st.executeUpdate(uup);
        String qqr="Update studentInput set mobile="+mobile+" where id="+id+" ;";
        int restu = st.executeUpdate(qqr);
          String sk="Update studentInput set city='"+city+"' where id="+id+" ;";
...
CoursesEnrolled(studentid,courseid),feepaid
 ...
 %>
  ...
  <%    
              ...
              <table Id="course-table" align="center">
               <div id="course-table">
                   <h2>Invalid Input<a href="modifystudent.jsp"><br>Try again</a></h2>
               </div>
              </table><%}
%>
            </div>
