...
<%
  ...
  try{
      ...
      String query="delete from employee where id="+ kd;
      int result=st.executeUpdate(query);
      
   %> 
   <center><H1><br><br><b>ONE UPLOAD FILE DELETED SUCCESSFULLY</b></H1></center>
    <%--
...
%>
 <link rel="stylesheet" href="css.css"/>
              <table Id="course-table" align="center">
               <div id="course-table">
                  <center> <h3>Error in deleting file ....try again</h3></center>
               </div>
              </table>
<%
}
