...
<%
  ...
  try{
      ...
      st=conn.createStatement();
       ...
       String quer="SELECT * FROM TeacherDetail where id=1";
...
CoursesEnrolled(studentid,courseid),feepaid
   --%><br>
   <form method="post" action="ChangePassword_1.jsp">
 ...
 %>
            <tr>
                <td> Id</td>
                <td> <input type="text" value="<%=rs.getInt("id")%>" name="id" readonly="1"</td>
            </tr><tr>
                <td>Name</td>
                <td><input type="text" value="<%=rs.getString("name")%>" name="name" readonly="1"></td>
      </tr><tr>    
          <td>Passord</td>
                <td><input type="text" value="<%=rs.getString("passord")%>" name="passord"></td>
      </tr>
      <%  }  %>    <tr>
