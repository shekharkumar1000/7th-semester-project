...
<%
  ...
  try{
      ...
      String passord=request.getParameter("passord");
       ...
       String qq="Update TeacherDetail set id="+id+" where id="+id+" ;";
        int resu = st.executeUpdate(qq);
        String r="Update TeacherDetail set name='"+name+"' where id="+id+" ;";
        int rer = st.executeUpdate(r);
        String up="Update TeacherDetail set passord='"+passord+"' where id="+id+" ;";
         int rr = st.executeUpdate(up);
       String quer="SELECT * FROM TeacherDetail";
...
CoursesEnrolled(studentid,courseid),feepaid
  --%>
  <center><h1>CHANGE PASSWORD DONE SUCCESSFULLY </h1></center>
  ...
  <%    
              ...
              <table Id="course-table" align="center">
               <div id="course-table">
                   <h2>Invalid Input<a href="ChangePassword.jsp"><br>Try again</a></h2>
               </div>
              </table><%}
%>
            </div>
