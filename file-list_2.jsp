...
<html>
  ...
  try{
      ...
      ResultSet rs = st.executeQuery(quer);
        %>
        <form method="post" action="profile_8_1.jsp">
        <table border="2" Id="course-table" align="center">
    
            <tr>
                <th>ID</th><th>Chapter Name</th><th>Topic Name</th><th>File Name</th><th>File Path</th><th>Added Date</th><th>Select</th>
            </tr>
            <%
            ...
            %>
            <tr>
                 <td colspan="7" align="center" ><input type="submit" value="DELETE"></td>
