  ...
  try{
      ...
      st=conn.createStatement();
       String id=(String)session.getAttribute("id");
        String amo=(String)session.getAttribute("amunt");
       String r="Update studentMaster Inner join CoursesEnrolled on CoursesEnrolled.studentid=studentMaster.id Inner join CourseMaster on CoursesEnrolled.courseid=CourseMaster.id Inner join feepaid on feepaid.id=CoursesEnrolled.eid set amount=amount+"+amo+" where feepaid.id="+id+";";
       int rs = st.executeUpdate(r);
      
   %> 
   
  <center><h1>AMOUNT UPDATED SUCCESSFULLY</h1></center><BR><BR>
