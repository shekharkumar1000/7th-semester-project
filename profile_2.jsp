...
CoursesEnrolled(studentid,courseid),feepaid
  ...
  <br>
          ...
          <table Id="course-table" border="2" align="center">
           <tr><td>Name Of Chapter</td><td><input type="text" name="Course" required ></td></tr>
            <tr><td>Type Your Question</td><td> <TEXTAREA NAME="Question" rows="4" cols="50" required ></TEXTAREA></td></tr>
